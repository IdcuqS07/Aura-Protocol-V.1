    ...
    <div className="min-h-screen pt-16 px-4 py-8" data-testid="analytics-page">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 fade-in">
          ...
          <p className="text-gray-400">Real-time insights into the Aura Protocol ecosystem</p>
        </div>

        {/* Key Metrics */}
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 card-hover" data-testid="metric-total-users">
          ...
          <div className="p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 card-hover" data-testid="metric-passports">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-cyan-600/20 rounded-lg">
                <Activity className="w-6 h-6 text-cyan-400" />
              </div>
              <div className="text-xs text-green-400 font-medium">+15.7%</div>
            </div>
            <div className="text-3xl font-bold text-white mb-1">
              {analytics?.total_credit_passports?.toLocaleString() || 0}
            </div>
            <div className="text-sm text-gray-400">Credit Passports</div>
          </div>

          <div className="p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 card-hover" data-testid="metric-volume">
            <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-3xl font-bold text-white mb-1">
              ${analytics?.total_transaction_volume?.toFixed(1) || 0}M
            </div>
