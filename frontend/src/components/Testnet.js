...
const Testnet = () => {
  ...
  const testSteps = [
    {
      id: 1,
      title: "Setup MetaMask for Polygon Mumbai",
      description: "Configure your wallet to connect to Polygon testnet",
      icon: Wallet,
      details: [
      ...
      action: "Add Network",
      link: "https://chainlist.org/chain/80001"
    },
    {
      id: 2,
    ...
    <div className="pt-20 px-4 space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-300 max-w-2xl mx-auto mb-6">
          Follow these steps to test Aura Protocol on Polygon Mumbai testnet. 
      ...
      <Card className="bg-gradient-to-r from-blue-900/50 to-purple-900/50 border-blue-500/50">
        ...
        <CardContent>
          <p className="text-gray-300">
            ...
            For real testnet, private key and contract deployment to Mumbai is required.
          </p>
      ...
      <Card className="bg-slate-800/50 border-slate-700">
        <CardHeader>
          <CardTitle className="text-white">Polygon Mumbai Network Details</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <div>
              <p className="text-gray-400">Network Name:</p>
              <p className="text-white font-mono">Polygon Mumbai</p>
            </div>
            <div>
              <p className="text-gray-400">Chain ID:</p>
              <p className="text-white font-mono">80001</p>
            </div>
            <div>
              <p className="text-gray-400">RPC URL:</p>
              <p className="text-white font-mono text-xs">https://rpc-mumbai.maticvigil.com</p>
            </div>
            <div>
